...
function seed(): DemoStore {
  ...
  const enrollments: EnrollmentApplication[] = [
    ...
    { id: 'enrollment-2', centerId: center.id, guardianName: 'Ana Cruz', guardianEmail: 'ana.cruz@example.com', guardianPhone: '(614) 555-0302', children: [{ name: 'Mateo Cruz', birthday: '2021-12-02', classroomId: 'room-meadow' }], requestedStart: ahead(35), status: 'toured', notes: 'Family visited Tuesday. Comparing two centers.', submittedAt: ago(20_500) },
    { id: 'enrollment-3', centerId: center.id, guardianName: 'Morgan James', guardianEmail: 'morgan.james@example.com', guardianPhone: '(614) 555-0303', children: [{ name: 'Willow James', birthday: '2024-09-27', classroomId: 'room-nest' }], requestedStart: ahead(14), status: 'waitlist', notes: 'Infant room at ratio — first on waitlist.', submittedAt: ago(30_000) },
